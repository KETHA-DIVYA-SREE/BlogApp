          ...
          <Row className="Articles">
            <Col xs={10} md={6}>
                ...
                return (
                    ...
                    <Row>
                    <Col xs={10} md={6}>
                    <Image src={ArticleData.srcimgFi} className="ArticleImg" />
                    </Col>
                    <Col xs={10} md={6}>
            ...
            <Col md={4} className="trile">
                <h2><u>Top P</u>ost</h2>
                <Image className="Post" src="https://image.freepik.com/free-vector/cartoon-background-home-gym-with-window_1441-2776.jpg" />
                ...
                return (
                    ...
                    <Image src={SubArticleData.srcimgFi} className="ArticleImg" />
                    </div>
