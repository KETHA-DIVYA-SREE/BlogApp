    ...
    return (
        <>
          <Row className="Articles">
            <Col xs={10} md={6}>
                <h2><u>Holly</u>wood</h2>
                {info.Article.map( (ArticleData)=>{
                return (
                    <div className="Article">
                    <Row>
                    <Col xs={10} md={6}>
                    <Image src={ArticleData.srcimgH} className="ArticleImg" />
                    </Col>
                    <Col xs={10} md={6}>
            ...
            <Col md={4} className="trile">
                <h2><u>Top P</u>ost</h2>
                <Image className="Post" src="https://images.news18.com/ibnlive/uploads/2019/11/Frozen-2-1.jpg?impolicy=website&width=534&height=356" />
                ...
                return (
                    ...
                    <Image src={SubArticleData.srcimgH} className="ArticleImg" />
                    </div>
